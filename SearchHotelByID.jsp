<%-- 
    Document   : HotelIdCode
    Created on : 29 Mar, 2023, 4:50:45 PM
    Author     : Nabiya
--%>
        ...
        <title>Search Hotel</title>
         <style>
            *{
             ...
             body{
                background:linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(hotel.jpg)no-repeat;
...
nav ul li a{
 ...
 <div class="navbar">
         ...
         <h1><b>SEARCH HOTEL RESULT</b></h1>
        <%@page import="java.sql.*" %>
        <%
            try{   // exception handling try block
                int r; ResultSet rs;   // variable declaration
                r=Integer.parseInt(request.getParameter("txthid"));  // catch value
           ...
           Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","travelbliss","travelbliss");    // for database connectivity
            String qry="select * from addhotel  where hotelid=?"; // send qry for execution 
        ...
        <div class="row">
            <table>
                <tr><td class="inputBox" style="color: white; padding: 10px;">Hotel Name:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("hotelnm")%>">
                    </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Location:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("location")%>">
                    </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Room Features:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("roomf")%>">
                    </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Rating:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("rating")%>">
                    </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Amenities:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("amenities")%>">
                    </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Phone No.:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("phnno")%>">
                    </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Price:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("price")%>">
                    </td></tr>
       ...
       <footer class="text-center text-lg-start" style="background:linear-gradient(45deg, midnightblue, transparent); margin-top: 150px; margin-right: 20px;">
  <!-- Grid container -->
