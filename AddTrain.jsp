<%-- 
    Document   : AddTrain
    Created on : 27 Feb, 2023, 10:21:51 PM
    Author     : Nabiya
--%>
...
body{
     background:linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(train.jpg)no-repeat;
 ...
 .a{
    ...
    <body>
        <div class="container">
            ...
            <form action="AddTrainDetails.jsp" class="form-group">
                 
                <h2 class="text-center">ADD TRAIN DETAILS</h2>
                <div class="box">
                <table>
                <tr> 
                    <td><div class="box1">
                    <h5>Train No.</h5>
                    <input type="text"  name="txttno" placeholder="Train No.">
                        </div></td>
                        <td> <div class="box2">
                    <h5>Train Name</h5>
                     <input type="text"  name="txttnm" placeholder="Train Name">
                            </div></td>
                </tr>
                <tr>
                    <td><div class="box1">
                ...
                <tr>
                    <td> <div class="box1">
                    <h5>Run Days</h5>
                    <input type="text"  name="txtrun" placeholder="Run days">
                        </div></td>
                        <td><div class="box2">
                    <h5>Fare</h5>
