<%-- 
    Document   : SearchFligthChar
    Created on : 27 Mar, 2023, 3:34:01 PM
    Author     : Nabiya
--%>
...
.input {
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="#"><i class="fa fa-user-times"></i>Logout</a></li>
            ...
            <h3 class="text-center">SEARCH FLIGHT</h3>
            </div>
        <form action="SearchFlightByID.jsp">
            <div>
          <div class="booking-form">
                    <label>Enter Flight No.</label>
                    <input type="text" name="txtfno" id="txtfno" class="input">
                </div>
             <div class="input-grp">
         ...
         <footer class="text-center text-lg-start" style="background:linear-gradient(45deg, midnightblue, transparent); margin-top: 210px; margin-right: 20px;">
  <!-- Grid container -->
