<%-- 
    Document   : SearchPackageID
    Created on : 30 Mar, 2023, 12:19:48 AM
    Author     : Nabiya
--%>
...
.input {
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="#"><i class="fa fa-user-times"></i>Logout</a></li>
            ...
            <h3 class="text-center">SEARCH PACKAGE</h3>
            </div>
        <form action="SearchPackageByID.jsp">
            <div>
          <div class="booking-form">
                    <label>Enter Package Id</label>
                    <input type="text" name="txtpid" class="input">
                </div>
             <div class="input-grp">
         ...
         <footer class="text-center text-lg-start" style="background:linear-gradient(45deg, midnightblue, transparent); margin-top: 210px;">
  <!-- Grid container -->
