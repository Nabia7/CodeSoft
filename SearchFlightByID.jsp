<%-- 
    Document   : SearchFlightByID
    Created on : 24 Mar, 2023, 10:47:18 PM
    Author     : Nabiya
--%>
    ...
    <head>
        ...
        <title>JSP Page</title>
            ...
            *{
             ...
             body{
                background:linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(plane.jpg)no-repeat;
...
nav ul li a{
  ...
  <div class="navbar">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="#" class="a1">AboutUs</a></li>
                          ...
                          <h1><b>FLIGHT STATUS</b></h1>
        <%@page import="java.sql.*" %>
        <%
            try{   // exception handling try block
                int r; ResultSet rs;   // variable declaration
                r=Integer.parseInt(request.getParameter("txtfno"));  // catch value
           ...
           Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","travelbliss","travelbliss");    // for database connectivity
            String qry="select * from addflight  where flightno=?"; // send qry for execution 
        ...
        <div class="row">
            <table>     
                <tr><td class="inputBox" style="color: white; padding: 10px;">Flight Name:</td>
                    <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("flightnm")%>">
                </td></tr>
                ...
                <tr><td class="inputBox" style="color: white; padding: 10px;">Source:</td> 
                 ...
                 <tr><td class="inputBox" style="color: white; padding: 10px;">Departure Time:</td>
                     <td>
                    <input type="text" class="card-number-input" value="<%= rs.getString("deptime")%>">
                </td></tr>
                 
                 <tr><td class="inputBox" style="color: white; padding: 10px;">Arrival Time:</td>
                     <td>
