<%-- 
    ...
    Created on : 1 Apr, 2023, 2:35:44 PM
    Author     : Nabiya
--%>
...
<html>
  ...
  <ul class="dropdown-menu bg-dark">
    ...
    <li><a class="dropdown-item text-light bg-dark" href="#"><i class="fa fa-sign-out"></i>Logout</a></li>
        ...
        <%! int transid,amt,cno,cv; String ctype, bank, holdernm, em, ey;ResultSet r; %>
        <%
           ...
           {
               String cnm=request.getParameter(session.getAttribute("cnm").toString());  //session declare
