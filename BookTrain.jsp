<%-- 
    ...
    Created on : 18 Mar, 2023, 10:21:53 PM
    Author     : Nabiya
--%>
    ...
    <body>
         ...
         <div class="navbar">
                ...
                <nav>
                  ...
                  <form action="PaymentTrain.jsp" class="form-group">
                      <h1 class="text-center text-white">Railway Booking Form</h1>
                      <div id="form">
                          <h3 class="text-white">Booking Details</h3>
                          
                          <div id="input">
                           <input type="text" id="input-group" placeholder="Train No."> 
                          ...
                          <select id="input-group">
                              ...
                              <option value="">Second Seating</option>
                              <option value="">First Class</option>
                              <option value="">Third AC Economy</option>
                          </select>
                      </div>
                          ...
                          <div id="input4">
                           ...
                           <div id="input5">
                              <h3 class="text-white">Passenger Details </h3>
                          </div>
