<%-- 
    Document   : SearchTrainByID
    Created on : 25 Mar, 2023, 12:25:50 AM
    Author     : Nabiya
--%>
...
nav ul li a{
   ...
   <div class="navbar">
          ...
          <h1><b>TRAIN STATUS</b></h1>
        <%@page import="java.sql.*" %>
        <%
            try{   // exception handling try block
                int r; ResultSet rs;   // variable declaration
                r=Integer.parseInt(request.getParameter("txttno"));  // catch value
           ...
           Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","travelbliss","travelbliss");    // for database connectivity
            String qry="select * from addtrain  where traino=?"; // send qry for execution 
        ...
        <div class="row">
            <table>
                <tr> <td class="inputBox" style="color: white; padding: 10px;">Train Name:</td>
                    <td>
                     <input type="text" class="card-number-input" value="<%= rs.getString("trainnm")%>">
                </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Departure:</td>
                    <td>
                     <input type="text" class="card-number-input" value="<%= rs.getString("deptime")%>">
                </td></tr>
                
               <tr><td class="inputBox" style="color: white; padding: 10px;">Return:</td> 
                   <td>
                     <input type="text" class="card-number-input" value="<%= rs.getString("arvltime")%>">
                </td></tr>
               
                <tr><td class="inputBox" style="color: white; padding: 10px;">Source:</td>
                    <td>
                     <input type="text" class="card-number-input" value="<%= rs.getString("source")%>">
                </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Destination:</td>
                    <td>
                     <input type="text" class="card-number-input" value="<%= rs.getString("destination")%>">
                </td></tr>
                
                <tr><td class="inputBox" style="color: white; padding: 10px;">Run Days:</td>
                    <td>
                     <input type="text" class="card-number-input" value="<%= rs.getString("rundays")%>">
                </td></tr>
                
               <tr><td class="inputBox" style="color: white; padding: 10px;">Fare:</td>
                   <td>
                   <input type="text" class="card-number-input" value="<%= rs.getString("fare")%>">
                   </td></tr>
